...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import MPICH_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7cb0a576-ebde-5e09-9194-50597f1243b4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "MPICH", artifacts_toml) for e in artifacts["MPICH"]]
...
if best_platform === nothing
    @debug("Unable to load MPICH; unsupported platform $(triplet(platform_key_abi()))")
else
